"""
Django settings for WeeDeliverProject project.
...
SECRET_KEY = '4#pzrxep+zq@0&o#x%3t+$8chtxm@ln-t8u$p*bij5y#!b#x7t'
...
ROOT_URLCONF = 'WeeDeliverProject.urls'

WSGI_APPLICATION = 'WeeDeliverProject.wsgi.application'
